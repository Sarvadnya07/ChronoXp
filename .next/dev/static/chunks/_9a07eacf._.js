...
class Database {
        ...
        this.initPromise = new Promise((resolve, reject)=>{
            ...
            request.onupgradeneeded = (event)=>{
                ...
                if (!db.objectStoreNames.contains("tasks")) {
                    ...
                    taskStore.createIndex("scheduledDate", "scheduledDate", {
                        unique: false
                    });
                ...
                if (!db.objectStoreNames.contains("xpLogs")) {
                    const xpStore = db.createObjectStore("xpLogs", {
                        keyPath: "id"
                    });
                    xpStore.createIndex("date", "date", {
                        unique: false
                    });
                    xpStore.createIndex("category", "category", {
                        unique: false
                    });
                }
                // Memory store
    ...
    async getDailyProgressRange(startDate, endDate) {
...
const firebaseConfig = {
    apiKey: ("TURBOPACK compile-time value", "AIzaSyC-xU5GLeeVLHH5d0lgz8vQ4rlPoQl6Ny0"),
    authDomain: ("TURBOPACK compile-time value", "chronoxp-d0dba.firebaseapp.com"),
    projectId: ("TURBOPACK compile-time value", "chronoxp-d0dba"),
    storageBucket: ("TURBOPACK compile-time value", "chronoxp-d0dba.firebasestorage.app"),
    messagingSenderId: ("TURBOPACK compile-time value", "159265258412"),
    appId: ("TURBOPACK compile-time value", "1:159265258412:web:b55054686a1a0777c11809"),
    measurementId: ("TURBOPACK compile-time value", "G-7YNBLMES8R")
};
// Initialize Firebase only if config is present
const app = firebaseConfig.apiKey ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$app$2f$dist$2f$esm$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["initializeApp"])(firebaseConfig) : null;
...
async function syncData(user) {
    ...
    const userRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["doc"])(db, "users", userId);
    // 1. Upload local data to Firestore
    const localProfile = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"].get("userProfile", "main");
    const localSettings = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"].get("settings", "main");
    const localTasks = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"].getAll("tasks");
    const localProgress = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"].getAll("dailyProgress");
    const dataToSync = {
        profile: localProfile,
        settings: localSettings,
        tasks: localTasks,
        progress: localProgress,
        lastSynced: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Timestamp"].now()
    };
    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["setDoc"])(userRef, dataToSync, {
        merge: true
    });
...
function calculateLevel(totalXP) {
    return Math.floor(totalXP / __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["XP_PER_LEVEL"]) + 1;
}
function getXPForNextLevel(totalXP) {
    const currentLevel = calculateLevel(totalXP);
    return currentLevel * __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["XP_PER_LEVEL"];
}
function getXPProgressInLevel(totalXP) {
    const currentLevelXP = (calculateLevel(totalXP) - 1) * __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["XP_PER_LEVEL"];
    return totalXP - currentLevelXP;
}
function calculateTaskXP(task) {
    const baseXP = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["XP_REWARDS"][task.category] || 10;
    return Math.round(baseXP * (task.difficulty === "easy" ? 1 : task.difficulty === "medium" ? 1.5 : 2));
}
function isStreakComplete(progress) {
    const dateObj = new Date(progress.date);
    const dayOfWeek = dateObj.getDay();
    for (const req of __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["STREAK_REQUIREMENTS"]){
...
async function checkStreakCompletion(date) {
    const progress = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"].get("dailyProgress", date);
    if (!progress) return false;
    return isStreakComplete(progress);
}
async function calculateStreak(profile) {
    const today = new Date();
    const endDate = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getLocalDate"])();
    ...
    const allProgress = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"].getDailyProgressRange(startDate, endDate);
    const progressMap = new Map(allProgress.map((p)=>[
            p.date,
            p
        ]));
    let currentStreak = 0;
...
function calculateEnergy(progress) {
    let energy = 100;
    // Sleep penalty (if sleep data exists)
    if (progress.sleep) {
        if (progress.sleep.totalHours < 7) {
            energy -= 20;
        }
...
function checkQuestCompletion(quests, task) {
    let xpGained = 0;
    const updatedQuests = quests.map((quest)=>{
        ...
        if (quest.targetCategory) {
            if (task.category === quest.targetCategory || quest.targetCategory === "Study" && [
                "DSA",
                "AI/ML",
                "GATE",
                "Japanese"
            ].includes(task.category) || quest.targetCategory === "Health" && [
                "Exercise",
                "Sleep"
...
async function updateBadgeProgress(profile) {
    const badges = profile.badges.map((b)=>({
            ...b
        }));
    const allProgress = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"].getAll("dailyProgress");
...
async function evaluateBadges(profile) {
    return updateBadgeProgress(profile);
}
function checkDailyQuestCompletion(quests, task) {
...
function scheduleDailySummary(stats) {
    const now = new Date();
...
function sendStreakWarning(streak) {
...
function checkBurnoutAndNotify(burnout) {
...
function checkSleepAndNotify(insights) {
...
"[project]/services/memoryEngine.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
const MemoryEngine = {
    async addMemory (type, key, value, strength = 0.5) {
        const memory = {
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"].put("memory", memory);
    },
    async getMemories (type) {
        const allMemories = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"].getAll("memory");
        if (type) {
            return allMemories.filter((m)=>m.type === type);
        }
        return allMemories;
    },
    async updateMemoryStrength (id, delta) {
        const memory = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"].get("memory", id);
        if (memory) {
            const newStrength = Math.min(1, Math.max(0, memory.strength + delta));
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"].put("memory", {
                ...memory,
    ...
    async consolidateMemories () {
        ...
        // For now, just a stub
        const memories = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"].getAll("memory");
        for (const mem of memories){
            if (mem.strength < 0.1) {
                // Forget weak memories
                await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"].delete("memory", mem.id);
            }
        }
    }
};
...
"[project]/lib/recurring.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/utils.ts [app-client] (ecmascript)");
;
function shouldGenerateTask(task, date) {
...
function generateRecurringTasks(tasks, date) {
...
function getNextOccurrence(task, fromDate = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getLocalDate"])()) {
...
"[project]/lib/ics.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$memoryEngine$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/services/memoryEngine.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$recurring$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/recurring.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firebase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/firebase.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$ics$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/ics.ts [app-client] (ecmascript)");
;
;
;
;
...
const useAppStore = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zustand$2f$esm$2f$react$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["create"])((set, get)=>({
        ...
        initializeApp: async ()=>{
            try {
                await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"].init();
                // Load or create user profile
                let profile = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"].get("userProfile", "main");
                if (!profile) {
                    profile = {
                        id: "main",
                        stats: {
                        ...
                        badges: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$gamification$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["initializeBadges"])(),
                        createdAt: Date.now(),
                        lastActive: Date.now(),
                        energy: {
                            current: 100,
                    ...
                    await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"].put("userProfile", profile);
                ...
                // Load settings
                let settings = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"].get("settings", "main");
                if (!settings) {
                    settings = {
                        id: "main",
                        notificationsEnabled: true,
                    ...
                    await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"].put("settings", settings);
                }
                // Load tasks
                const tasks = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"].getAll("tasks");
                // Load routines
                const routines = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"].getAll("routines");
                // Load or create today's progress
                const today = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getLocalDate"])();
                let todayProgress = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"].get("dailyProgress", today);
                if (!todayProgress) {
                    // Generate recurring tasks for today
                    const recurringTasks = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$recurring$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["generateRecurringTasks"])(tasks, today);
                    const todaysTasks = [
                    ...
                    await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"].put("dailyProgress", todayProgress);
                }
                // Schedule daily summary
                if (todayProgress) {
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$notifications$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["scheduleDailySummary"])({
        ...
        completeTask: async (taskId)=>{
            ...
            const xpEarned = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$gamification$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["calculateTaskXP"])(task);
            const updatedTasks = [
                ...todayProgress.tasks
            ];
            ...
            const newLevel = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$gamification$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["calculateLevel"])(newTotalXP);
            // Check badges
            const oldBadges = profile.badges;
            const updatedBadges = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$gamification$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["evaluateBadges"])({
                ...profile,
                stats: {
                    ...currentStats,
                    totalXP: newTotalXP,
            ...
            // Update Memory
            if (task.category) {
                __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$memoryEngine$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MemoryEngine"].addMemory("pattern", `completed_task_${task.category}`, {
                    taskId: task.id,
                    timestamp: Date.now()
                }, 0.1);
            }
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"].put("dailyProgress", updatedProgress);
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"].put("userProfile", updatedProfile);
            set({
        ...
        uncompleteTask: async (taskId)=>{
            ...
            const task = todayProgress.tasks[taskIndex];
            if (!task.completed) return;
            const xpLost = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$gamification$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["calculateTaskXP"])(task);
            const updatedTasks = [
                ...todayProgress.tasks
            ];
            updatedTasks[taskIndex] = {
            ...
            const updatedProfile = {
                ...
                stats: {
                    ...
                    level: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$gamification$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["calculateLevel"])(Math.max(0, profile.stats.totalXP - xpLost))
                },
                lastActive: Date.now()
            };
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"].put("dailyProgress", updatedProgress);
        ...
        addTask: async (taskData)=>{
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"].put("tasks", newTask);
            set({
                tasks: [
                    ...tasks,
                    newTask
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$notifications$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["scheduleTaskNotification"])(newTask);
        ...
        updateTask: async (taskId, updates)=>{
            ...
            if (task) {
                await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"].put("tasks", task);
                set({
                    tasks: updatedTasks
                });
                // Reschedule notification if time changed
                if (updates.scheduledTime) {
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$notifications$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["scheduleTaskNotification"])(task);
                }
            }
        },
        deleteTask: async (taskId)=>{
            const { tasks } = get();
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"].delete("tasks", taskId);
            set({
        ...
        updateMood: async (mood)=>{
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"].put("dailyProgress", updated);
            set({
        ...
        refreshProfile: async ()=>{
            const profile = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"].get("userProfile", "main");
            const today = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getLocalDate"])();
            const todayProgress = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"].get("dailyProgress", today);
            if (profile) {
                await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"].put("userProfile", profile);
            }
            set({
        ...
        updateSettings: async (updates)=>{
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"].put("settings", updated);
            set({
                settings: updated
            });
        },
        ...
        login: async ()=>{
            try {
                const user = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firebase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["loginWithGoogle"])();
                if (user) {
                    await get().sync();
                }
            } catch (error) {
        ...
        importICS: async (content)=>{
            const parsedTasks = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$ics$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseICS"])(content);
            const { tasks } = get();
            const newTasks = [];
        ...
        saveRoutine: async (name, tasks, templateType = "custom")=>{
            const template = {
                id: `routine-${Date.now()}`,
                name,
                templateType,
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"].put("routines", template);
        ...
        deleteRoutine: async (id)=>{
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"].delete("routines", id);
        }
    }));
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
...
function AuthProvider({ children }) {
    ...
    const { initializeApp, settings } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAppStore"])();
...
_s(AuthProvider, "UB0MsS7iM9GQBtxsimjdtJofNh0=", false, function() {
    return [
...
//# sourceMappingURL=_9a07eacf._.js.map